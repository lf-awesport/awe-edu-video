...
const Scene13 = ({scene}: SceneProps) => {
  ...
  return <SceneShell scene={scene}>
    ...
    <div style={{position: 'absolute', left: 0, right: 0, top: 700, textAlign: 'center', fontSize: 66, lineHeight: 1.04, fontWeight: 900, letterSpacing: -3, opacity: cta, transform: `translateY(${(1 - cta) * 42}px)`}}>Porta la formazione sportiva<br /><span style={{color: brand.colors.white}}>nella tua community.</span></div>
  </SceneShell>;
};
